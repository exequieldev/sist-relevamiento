...
@section('content')
  <!--Encabezado-->
  <div class="row">
    <h1>Generos <a href={{url('genero/create')}}><button class="btn btn-success">Nuevo</button></a></h1>
  </div>
  <div class="row">
              ...
              <tr>
                ...
                <td>
                      <div class="btn-toolbar">
                          <a href="{{url('genero/'.$genero->idGenero.'/edit')}}"><button class="btn btn-info" ><i class="fas fa-edit"></i></button></a>
                          <a href="#">
