...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Relevamientos` (
  ...
  CONSTRAINT `fk_Relevamientos_Casas1`
    FOREIGN KEY (`idCasa`)
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`Vinculos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Vinculos` (
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`Generos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Generos` (
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`situacionOcupacionales`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`situacionOcupacionales` (
  `idsituacionOcupacional` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(255) NOT NULL,
  `estado` TINYINT NOT NULL,
  PRIMARY KEY (`idsituacionOcupacional`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Personas` (
  ...
  `idNivel` INT NULL,
  `idsituacionOcupacional` INT NULL,
  ...
  CONSTRAINT `fk_Personas_hogares1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Personas_Vinculos1`
    FOREIGN KEY (`idVinculo`)
    REFERENCES `dbsistRel`.`Vinculos` (`idVinculo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Personas_Generos1`
    FOREIGN KEY (`idGenero`)
    REFERENCES `dbsistRel`.`Generos` (`idGenero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Personas_Niveles1`
    FOREIGN KEY (`idNivel`)
    REFERENCES `dbsistRel`.`Niveles` (`idNivel`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Personas_situtacionesOcupacionales1`
    FOREIGN KEY (`idsituacionOcupacional`)
    REFERENCES `dbsistRel`.`situacionOcupacionales` (`idsituacionOcupacional`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`Ocupaciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Ocupaciones` (
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Ingresos` (
  ...
  CONSTRAINT `fk_Ingresos_Personas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Ingresos_Ocupaciones1`
    FOREIGN KEY (`idOcupacion`)
    REFERENCES `dbsistRel`.`Ocupaciones` (`idOcupacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`situacionHabitacionales`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`situacionHabitacionales` (
  `idsituacionHabitacional` INT NOT NULL AUTO_INCREMENT,
  `tenecia` VARCHAR(45) NULL,
  `permisoOcupacion` TINYINT NULL,
  `tipoLote` VARCHAR(45) NULL,
  `idLote` INT NOT NULL,
  `idPersona` INT NOT NULL,
  PRIMARY KEY (`idsituacionHabitacional`),
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`Politicas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Politicas` (
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Programas` (
  ...
  CONSTRAINT `fk_Programas_Politicas1`
    FOREIGN KEY (`idPolitica`)
    REFERENCES `dbsistRel`.`Politicas` (`idPolitica`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`CasasdetalleConstrucciones` (
  `idCasasdetalleConstrucciones` INT NOT NULL AUTO_INCREMENT,
  `idCasa` INT NOT NULL,
  `iddetalleConstruccion` INT NOT NULL,
  PRIMARY KEY (`idCasasdetalleConstrucciones`),
  CONSTRAINT `fk_Casas_has_detalleConstrucciones_Casas1`
    FOREIGN KEY (`idCasa`)
    REFERENCES `dbsistRel`.`Casas` (`idCasa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Casas_has_detalleConstrucciones_detalleConstrucciones1`
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`hogaresProgramas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`hogaresProgramas` (
  `idhogaresProgramas` INT NOT NULL AUTO_INCREMENT,
  `cantidad` VARCHAR(45) NULL,
  `idPrograma` INT NOT NULL,
  `idhogar` INT NOT NULL,
  PRIMARY KEY (`idhogaresProgramas`, `idhogar`),
  CONSTRAINT `fk_hogaresProgramas_Programas1`
    FOREIGN KEY (`idPrograma`)
    REFERENCES `dbsistRel`.`Programas` (`idPrograma`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_hogaresProgramas_hogares1`
    FOREIGN KEY (`idhogar`)
    REFERENCES `dbsistRel`.`hogares` (`idhogar`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`hogaresMovimientos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`hogaresMovimientos` (
  `idhogaresMovimientos` INT NOT NULL AUTO_INCREMENT,
  `idMovimientoSocial` INT NOT NULL,
  `idhogar` INT NOT NULL,
  PRIMARY KEY (`idhogaresMovimientos`),
  CONSTRAINT `fk_hogaresMoviemientos_MovimientoSociales1`
    FOREIGN KEY (`idMovimientoSocial`)
    REFERENCES `dbsistRel`.`MovimientoSociales` (`idMovimientoSocial`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_hogaresMoviemientos_hogares1`
    FOREIGN KEY (`idhogar`)
    REFERENCES `dbsistRel`.`hogares` (`idhogar`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`Embarazos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Embarazos` (
  `idEmbarazo` INT NOT NULL AUTO_INCREMENT,
  `mesesEmbarazo` VARCHAR(45) NOT NULL,
  `idPersona` INT NOT NULL,
  PRIMARY KEY (`idEmbarazo`),
  CONSTRAINT `fk_Embarazos_Personas1`
    FOREIGN KEY (`idPersona`)
    REFERENCES `dbsistRel`.`Personas` (`idPersona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`hogarInstitucionMedicas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`hogarInstitucionMedicas` (
  `idhogarInstitucionMedicas` INT NOT NULL AUTO_INCREMENT,
  `idhogar` INT NOT NULL,
  `idInstitucionMedica` INT NOT NULL,
  PRIMARY KEY (`idhogarInstitucionMedicas`),
  CONSTRAINT `fk_hogarInstitucionMedicas_hogares1`
    FOREIGN KEY (`idhogar`)
    REFERENCES `dbsistRel`.`hogares` (`idhogar`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_hogarInstitucionMedicas_InstitucionMedicas1`
    FOREIGN KEY (`idInstitucionMedica`)
    REFERENCES `dbsistRel`.`InstitucionMedicas` (`idInstitucionMedica`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`ObraSociales`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`ObraSociales` (
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`hogarObraSociales`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`hogarObraSociales` (
  `idhogarObraSociales` INT NOT NULL AUTO_INCREMENT,
  `idhogar` INT NOT NULL,
  `idObraSocial` INT NOT NULL,
  PRIMARY KEY (`idhogarObraSociales`),
  CONSTRAINT `fk_hogarObraSociales_hogares1`
    FOREIGN KEY (`idhogar`)
    REFERENCES `dbsistRel`.`hogares` (`idhogar`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_hogarObraSociales_ObrasSociales1`
    FOREIGN KEY (`idObraSocial`)
    REFERENCES `dbsistRel`.`ObraSociales` (`idObraSocial`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
