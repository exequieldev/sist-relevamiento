...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Construcciones` (
  `idContruccion` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NULL,
  PRIMARY KEY (`idContruccion`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`detalleConstrucciones` (
  ...
  `nombre` VARCHAR(45) NULL,
  `estado` TINYINT NULL,
  `idContruccion` INT NOT NULL,
  PRIMARY KEY (`iddetalleConstruccion`),
  CONSTRAINT `fk_detalleConstrucciones_tipoConstrucciones1`
    FOREIGN KEY (`idContruccion`)
    REFERENCES `dbsistRel`.`Construcciones` (`idContruccion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Casas` (
  ...
  CONSTRAINT `fk_Casas_Lotes1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Casas_detalleConstrucciones1`
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`CasaHabitaciones` (
  ...
  CONSTRAINT `fk_CasaHabitaciones_Casas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CasaHabitaciones_Habitaciones1`
    FOREIGN KEY (`idHabitacion`)
    REFERENCES `dbsistRel`.`Habitaciones` (`idHabitacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
