...
-- -----------------------------------------------------
-- Table `dbsistRel`.`situtacionesOcupacionales`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`situtacionesOcupacionales` (
  `idsitutacionesOcupacionales` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(255) NOT NULL,
  `estado` TINYINT NOT NULL,
  PRIMARY KEY (`idsitutacionesOcupacionales`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`Personas` (
  ...
  `idNivel` INT NULL,
  `idsitutacionesOcupacionales` INT NOT NULL,
  ...
  CONSTRAINT `fk_Personas_situtacionesOcupacionales1`
    FOREIGN KEY (`idsitutacionesOcupacionales`)
    REFERENCES `dbsistRel`.`situtacionesOcupacionales` (`idsitutacionesOcupacionales`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`hogaresMovimientos` (
  `idhogaresMovimientos` INT NOT NULL,
  `idMovimientoSocial` INT NOT NULL,
  `idhogar` INT NOT NULL,
  PRIMARY KEY (`idhogaresMovimientos`, `idMovimientoSocial`),
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`hogarInstitucionMedicas` (
  `idhogarInstitucionMedicas` INT NOT NULL,
  `idhogar` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `dbsistRel`.`ObrasSociales`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbsistRel`.`ObrasSociales` (
  `idObrasSociales` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
  `estado` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idObrasSociales`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbsistRel`.`hogarObraSociales` (
  `idhogarObraSociales` INT NOT NULL,
  `idhogar` INT NOT NULL,
  `idObrasSociales` INT NOT NULL,
  ...
  CONSTRAINT `fk_hogarObraSociales_ObrasSociales1`
    FOREIGN KEY (`idObrasSociales`)
    REFERENCES `dbsistRel`.`ObrasSociales` (`idObrasSociales`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
